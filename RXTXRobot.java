...
public class RXTXRobot extends SerialCommunication
{
    ...
    final public static int PING1 = 8;

    final public static int PING2 = 13;
    ...
    /**
     * Gets the result from the Ping sensor (must be on digital pin 13 or 8).
     *
     * The Ping sensor must be on digital pin 8 or 13 and this method returns the distance in centimeters.
     * @param The pin number (must be 8 or 13) that the ping sensor is on
